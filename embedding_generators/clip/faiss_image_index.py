...
Usage:
    python legacy/clip/faiss_image_index.py final_dataset_embeddings
    python legacy/clip/faiss_image_index.py final_dataset_embeddings --output-dir custom_index
    python legacy/clip/faiss_image_index.py final_dataset_embeddings --use-ivf
    python legacy/clip/faiss_image_index.py --search final_dataset_embeddings/faiss_index --query image.png
"""
